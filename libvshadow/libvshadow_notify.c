...
{
	static char *function = "libvshadow_notify_set_stream";
...
int libvshadow_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libvshadow_notify_stream_open";
...
int libvshadow_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libvshadow_notify_stream_close";
