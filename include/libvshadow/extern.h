...
#if !defined( _LIBVSHADOW_EXTERN_H )
#define _LIBVSHADOW_EXTERN_H

/* To export functions from the libvshadow DLL define LIBVSHADOW_DLL_EXPORT
 * To import functions from the libvshadow DLL define LIBVSHADOW_DLL_IMPORT
