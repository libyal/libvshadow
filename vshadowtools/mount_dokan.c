...
NTSTATUS __stdcall mount_dokan_ZwCreateFile(
                    const wchar_t *path,
                    DOKAN_IO_SECURITY_CONTEXT *security_context VSHADOWTOOLS_ATTRIBUTE_UNUSED,
                    ACCESS_MASK desired_access,
                    ULONG file_attributes VSHADOWTOOLS_ATTRIBUTE_UNUSED,
                    ULONG share_access VSHADOWTOOLS_ATTRIBUTE_UNUSED,
                    ULONG creation_disposition,
                    ULONG creation_options VSHADOWTOOLS_ATTRIBUTE_UNUSED,
                    DOKAN_FILE_INFO *file_info )
{
	libcerror_error_t *error = NULL;
	...
	VSHADOWTOOLS_UNREFERENCED_PARAMETER( security_context )
	VSHADOWTOOLS_UNREFERENCED_PARAMETER( file_attributes )
	VSHADOWTOOLS_UNREFERENCED_PARAMETER( share_access )
	VSHADOWTOOLS_UNREFERENCED_PARAMETER( creation_options )
