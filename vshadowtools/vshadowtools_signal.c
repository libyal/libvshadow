...
void (*vshadowtools_signal_signal_handler)( vshadowtools_signal_t ) = NULL;
             ...
             unsigned long signal )
{
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( vshadowtools_signal_signal_handler != NULL )
			{
				vshadowtools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
...
{
	static char *function = "vshadowtools_signal_attach";
...
#if defined( _MSC_VER )
	vshadowtools_signal_initialize_memory_debug();
#endif
     ...
     libcerror_error_t **error )
{
	...
	vshadowtools_signal_signal_handler = NULL;
