...
#if !defined( _VSHADOWTOOLS_GETOPT_H )
#define _VSHADOWTOOLS_GETOPT_H
...
typedef struct vshadowtools_option vshadowtools_option_t;

struct vshadowtools_option
{
...
#define vshadowtools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t vshadowtools_getopt(
                  int argument_count,
...
void vshadowtools_getopt_wrapped_fprint(
      FILE *stream,
...
void vshadowtools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const vshadowtools_option_t *options,
      int number_of_options );

int vshadowtools_getopt_get_options_string(
     const vshadowtools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _VSHADOWTOOLS_GETOPT_H ) */
